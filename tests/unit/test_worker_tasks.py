...
def test_enqueue_generation_calls_delay() -> None:
...
def test_enqueue_generation_empty_job_id_raises() -> None:
	import pytest
	from gbedu_api.worker_tasks import enqueue_generation
...
def test_enqueue_generation_import_error_graceful() -> None:
	from gbedu_api.worker_tasks import enqueue_generation
...
def test_revoke_task_calls_control_revoke() -> None:
...
def test_revoke_task_empty_id_raises() -> None:
	import pytest
	from gbedu_api.worker_tasks import revoke_task
...
def test_revoke_task_import_error_graceful() -> None:
	from gbedu_api.worker_tasks import revoke_task
...
def test_enqueue_voice_training_calls_delay() -> None:
...
def test_enqueue_voice_training_empty_id_raises() -> None:
	import pytest
	from gbedu_api.worker_tasks import enqueue_voice_training
...
def test_enqueue_voice_training_import_error_graceful() -> None:
	from gbedu_api.worker_tasks import enqueue_voice_training
...
def test_enqueue_welcome_email_calls_delay() -> None:
...
def test_enqueue_welcome_email_empty_id_raises() -> None:
	import pytest
	from gbedu_api.worker_tasks import enqueue_welcome_email
...
def test_enqueue_welcome_email_import_error_graceful() -> None:
	from gbedu_api.worker_tasks import enqueue_welcome_email
...
def test_enqueue_verify_email_calls_delay() -> None:
...
def test_enqueue_verify_email_empty_user_id_raises() -> None:
	import pytest
	from gbedu_api.worker_tasks import enqueue_verify_email
...
def test_enqueue_verify_email_empty_url_raises() -> None:
	import pytest
	from gbedu_api.worker_tasks import enqueue_verify_email
...
def test_enqueue_verify_email_import_error_graceful() -> None:
	from gbedu_api.worker_tasks import enqueue_verify_email
...
def test_enqueue_password_reset_email_calls_delay() -> None:
...
def test_enqueue_password_reset_email_empty_user_id_raises() -> None:
	import pytest
	from gbedu_api.worker_tasks import enqueue_password_reset_email
...
def test_enqueue_password_reset_email_empty_url_raises() -> None:
	import pytest
	from gbedu_api.worker_tasks import enqueue_password_reset_email
...
def test_enqueue_password_reset_email_import_error_graceful() -> None:
	from gbedu_api.worker_tasks import enqueue_password_reset_email
