...
def test_gbedu_error_base() -> None:
...
def test_gbedu_error_with_details() -> None:
	e = GbeduError("oops", details={"key": "value"})
	assert e.details == {"key": "value"}


def test_gbedu_error_to_dict() -> None:
...
def test_gbedu_error_custom_error_code() -> None:
...
def test_token_invalid_error() -> None:
	e = TokenInvalidError()
...
def test_validation_error_no_field() -> None:
...
def test_not_found_error_with_identifier() -> None:
...
def test_not_found_error_without_identifier() -> None:
...
def test_database_integrity_error_with_constraint() -> None:
...
def test_all_errors_are_gbedu_error() -> None:
	errors = [
		ValidationError("x"),
		AuthenticationError(),
		TokenExpiredError(),
