...
from gbedu_core.errors import GbeduError, NotFoundError, AuthorizationError
...
async def get_stems(
	...
	raw_stems: dict = track.stem_urls or {}
...
async def share_track(
	...
	return ShareCardResponse(
		...
		og_description=(
			f"A {track.sub_genre.value} track generated by AI. "
			f"Listen on Gbẹdu."
		),
